// SIA B2B — Shared icons (minimal inline SVG)
const Icon = ({ name, size = 16, ...props }) => {
  const icons = {
    ...
    car: <><path d="M5 17H3a1 1 0 0 1-1-1v-3l1.2-5.4A2 2 0 0 1 5.2 6H18.8a2 2 0 0 1 2 1.6L22 13v3a1 1 0 0 1-1 1h-2"/><circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/><path d="M9 17h6"/></>,
    ...
    inbox: <><path d="M22 12h-6l-2 3h-4l-2-3H2"/><path d="M5.5 5.3A2 2 0 0 1 7.3 4h9.4a2 2 0 0 1 1.8 1.3L22 12v6a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-6l3.5-6.7Z"/></>,
    send: <path d="m22 2-7 20-4-9-9-4 20-7Z" />,
    file: <><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9l-7-7Z"/><path d="M13 2v7h7"/></>,
    filter: <path d="M3 4h18v2l-7 8v6l-4 2v-8L3 6V4Z" />,
    ...
    tag: <><path d="M20.6 13.6 12 22l-9.6-9.6a5.5 5.5 0 1 1 7.8-7.8l1.8 1.8 1.8-1.8a5.5 5.5 0 1 1 7.8 7.8Z"/></>,
    ...
    phone: <path d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3 19.5 19.5 0 0 1-6-6 19.8 19.8 0 0 1-3-8.6A2 2 0 0 1 4 2h3a2 2 0 0 1 2 1.7 13 13 0 0 0 .7 2.8 2 2 0 0 1-.5 2.1L8 9.8a16 16 0 0 0 6 6l1.2-1.2a2 2 0 0 1 2-.5 13 13 0 0 0 2.9.7 2 2 0 0 1 1.7 2Z" />,
    ...
    sparkle: <path d="M12 3 13.5 8.5 19 10l-5.5 1.5L12 17l-1.5-5.5L5 10l5.5-1.5Z" />,
    moreH: <><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/></>,
    layers: <><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/></>,
    barcode: <><path d="M3 5v14M7 5v14M11 5v10M15 5v14M19 5v10"/></>,
    close: <><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></>,
  };
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"
      style={{ flexShrink: 0, display: 'inline-block', verticalAlign: 'middle' }} {...props}>
      {icons[name]}
    </svg>
  );
};
